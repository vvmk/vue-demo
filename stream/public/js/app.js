...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utilities_Form__ = __webpack_require__(180);
...
var routes = [{ path: '/', component: __webpack_require__(36) }, { path: '/about', component: __webpack_require__(44) }, { path: '/contact', component: __webpack_require__(47) }];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_AddToStream__ = __webpack_require__(177);
      ...
      _c("div", { staticClass: "row justify-content-center" }, [
        _c("div", { staticClass: "col-md-8" }, [
          _c("div", { staticClass: "card card-default" }, [
            ...
            _c("div", { staticClass: "card-body" }, [
              _vm._v(
                "\n                    I'm an example Contact component.\n                "
              )
            ])
          ])
        ])
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Errors_js__ = __webpack_require__(181);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
  ...
  _createClass(Form, [{
    ...
    value: function submit(requestType, url) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        axios[requestType](url, _this.requestBody).then(function (response) {
          var d = response.data;
    ...
    value: function reset() {
      for (var k in this.originalData) {
        this[k] = '';
      }
    ...
    get: function get() {
      ...
      for (var prop in this.originalData) {
        d[prop] = this[prop];
      }
